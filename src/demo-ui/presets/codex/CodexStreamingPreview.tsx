...
import {codexStreamingBaseState, codexStreamingScript} from '../../fixtures/codex'

export const CodexStreamingPreview = () => {
  const frame = useCurrentFrame()
  const {fps} = useVideoConfig()
  const state = getCodexStateAtTime(codexStreamingBaseState, codexStreamingScript, framesToSeconds(frame, fps))
